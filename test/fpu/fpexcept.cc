...
BOOST_AUTO_TEST_CASE(BSUN) {
    ...
    run_test(0, EXCEPTION_NUMBER::FP_UNORDER);
}
BOOST_AUTO_TEST_CASE(INEX1) {
    ...
    cpu.A[4] = 0x100;
    run_test(8, EXCEPTION_NUMBER::FP_INEX);
}
...
BOOST_AUTO_TEST_CASE(INEX2) {
    ...
    TEST::SET_FP(3, 1.1);
    cpu.A[4] = 0x1000;
    run_test(14, EXCEPTION_NUMBER::FP_INEX);
}
...
BOOST_AUTO_TEST_CASE(DV0) {
    ...
    TEST::SET_FP(3, 2.0);
    TEST::SET_FP(2, 0.0);
    run_test(20, EXCEPTION_NUMBER::FP_DIV0);
}
...
BOOST_AUTO_TEST_CASE(UNFL) {
    ...
    run_test(26, EXCEPTION_NUMBER::FP_UNFL);
}
...
BOOST_AUTO_TEST_CASE(OPERR) {
    ...
    run_test(32, EXCEPTION_NUMBER::FP_OPERR);
}
...
BOOST_AUTO_TEST_CASE(OVFL) {
    ...
    run_test(26, EXCEPTION_NUMBER::FP_OVFL);
}
...
BOOST_AUTO_TEST_CASE(SNAN_) {
    ...
    run_test(38, EXCEPTION_NUMBER::FP_SNAN);
}
