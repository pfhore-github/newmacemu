...
BOOST_FIXTURE_TEST_SUITE(FLOGN, Prepare)
BOOST_AUTO_TEST_CASE(qnan) { qnan_test(0b0010100); }

BOOST_AUTO_TEST_CASE(snan) { snan_test(0b0010100); }

BOOST_AUTO_TEST_CASE(pinf) {
    TEST::SET_FP(3, INFINITY);
    TEST::SET_W(0, 0171000);
    TEST::SET_W(2, 0b0010100 | 3 << 10 | 2 << 7);
    decode_and_run();
