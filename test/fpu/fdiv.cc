...
BOOST_FIXTURE_TEST_SUITE(FDIV, Prepare)
...
BOOST_FIXTURE_TEST_SUITE(FSDIV, Prepare, *boost::unit_test::tolerance(1e-5))
BOOST_AUTO_TEST_CASE(qnan) {
    mpfr_set_nan(cpu.FP[3]);
    cpu.FP_nan[3] = 0xffff000000000000LLU;
    TEST::SET_FP(2, 0.0);
    TEST::SET_W(0, 0171000);
    TEST::SET_W(2, 0B1100000 | 3 << 10 | 2 << 7);
    run_test();
    BOOST_TEST(mpfr_nan_p(cpu.FP[2]));
    BOOST_TEST(cpu.FP_nan[2] == 0xffff000000000000LLU);
}
...
BOOST_FIXTURE_TEST_SUITE(FDDIV, Prepare)
BOOST_AUTO_TEST_CASE(qnan) {
    mpfr_set_nan(cpu.FP[3]);
    cpu.FP_nan[3] = 0xffff000000000000LLU;
    TEST::SET_FP(2, 0.0);
    TEST::SET_W(0, 0171000);
    TEST::SET_W(2, 0B1100100 | 3 << 10 | 2 << 7);
    run_test();
    BOOST_TEST(mpfr_nan_p(cpu.FP[2]));
    BOOST_TEST(cpu.FP_nan[2] == 0xffff000000000000LLU);
}
