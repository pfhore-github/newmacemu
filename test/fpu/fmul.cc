...
struct F_FxMUL {
    F_FxMUL() {
        ...
        TEST::SET_W(8, 0B1100011 | 3 << 10 | 2 << 7);
        TEST::SET_W(10, TEST_BREAK);

        // FDMUL %FP3, %FP2
        TEST::SET_W(12, 0171000);
        TEST::SET_W(14, 0B1100111 | 3 << 10 | 2 << 7);
        TEST::SET_W(16, TEST_BREAK);

        jit_compile(0, 18);
    }
};
BOOST_FIXTURE_TEST_SUITE(FxMUL, Prepare, *boost::unit_test::fixture<F_FxMUL>())

BOOST_AUTO_TEST_SUITE(FMUL)
...
BOOST_AUTO_TEST_CASE(normal) {
    ...
    TEST::SET_FP(2, 3.0);
    run_test(6);
    BOOST_TEST(TEST::GET_FP(2) == 6.0f, boost::test_tools::tolerance(1e-5));
}
