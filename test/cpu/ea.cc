...
BOOST_DATA_TEST_CASE(cc, bdata::xrange(4), value) {
    cpu.A[2] = 0x2000;
    cpu.D[3] = 0x10;
    TEST::SET_W(0, 3 << 12 | 1 << 11 | value << 9 | 0x08);
...
BOOST_AUTO_TEST_CASE(full) {
    cpu.A[2] = 0x2000;
    cpu.D[3] = 0x100;
    TEST::SET_W(0, 3 << 12 | 1 << 11 | 1 << 8 | 2 << 4);
    TEST::SET_W(2, 0x400);
...
BOOST_AUTO_TEST_CASE(bd_l) {
    cpu.A[2] = 0x2000;
    cpu.D[3] = 0x100;
    TEST::SET_W(0, 3 << 12 |1 << 11 |  1 << 8 | 3 << 4);
...
BOOST_AUTO_TEST_CASE(no_bd) {
    cpu.A[2] = 0x2000;
    cpu.D[3] = 0x100;
    TEST::SET_W(0, 3 << 12 |1 << 11 |  1 << 8 | 1 << 4);
...
BOOST_AUTO_TEST_CASE(a_supress) {
    cpu.A[2] = 0x2000;
    cpu.D[3] = 0x100;
    TEST::SET_W(0, 3 << 12 | 1 << 11 | 1 << 8 | 1 << 7 | 2 << 4);
    TEST::SET_W(2, 0x400);
...
BOOST_AUTO_TEST_CASE(r_supress) {
    cpu.A[2] = 0x2000;
    cpu.D[3] = 0x100;
    TEST::SET_W(0, 3 << 12 |1 << 11 |  1 << 8 | 1 << 6 | 2 << 4);
    TEST::SET_W(2, 0x400);
...
BOOST_AUTO_TEST_CASE(no_od) {
    cpu.A[2] = 0x1000;
    cpu.D[3] = 0x100;
    TEST::SET_W(0, 3 << 12 | 1 << 11 | 1 << 8 | 2 << 4 | 1);
    TEST::SET_W(2, 0x400);
...
BOOST_AUTO_TEST_CASE(od_w) {
    cpu.A[2] = 0x1000;
    cpu.D[3] = 0x100;
    TEST::SET_W(0, 3 << 12 |1 << 11 |  1 << 8 | 2 << 4 | 2);
    TEST::SET_W(2, 0x400);
    TEST::SET_W(4, 0x300);
    TEST::SET_L(0x1500, 0x2000);
...
BOOST_AUTO_TEST_CASE(od_l) {
    cpu.A[2] = 0x1000;
    cpu.D[3] = 0x100;
    TEST::SET_W(0, 3 << 12 | 1 << 11 | 1 << 8 | 2 << 4 | 3);
    TEST::SET_W(2, 0x400);
...
BOOST_AUTO_TEST_CASE(no_od) {
    cpu.A[2] = 0x1000;
    cpu.D[3] = 0x100;
    TEST::SET_W(0, 3 << 12 | 1 << 11 | 1 << 8 | 2 << 4 | 1 << 2 | 1);
    TEST::SET_W(2, 0x400);
...
BOOST_AUTO_TEST_CASE(od_w) {
    cpu.A[2] = 0x1000;
    cpu.D[3] = 0x100;
    TEST::SET_W(0, 3 << 12 | 1 << 11 | 1 << 8 | 2 << 4 | 1 << 2 | 2);
    TEST::SET_W(2, 0x400);
    TEST::SET_W(4, 0x500);
...
BOOST_AUTO_TEST_CASE(od_l) {
    cpu.A[2] = 0x1000;
    cpu.D[3] = 0x100;
    TEST::SET_W(0, 3 << 12 | 1 << 11 | 1 << 8 | 2 << 4 | 1 << 2 | 3);
    TEST::SET_W(2, 0x400);
    TEST::SET_L(4, 0x10000);
    TEST::SET_L(0x1400, 0x2000);
    BOOST_TEST(ea_getaddr(6, 2, 0) == 0x12100);
