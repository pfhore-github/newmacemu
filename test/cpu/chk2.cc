...
struct F_CHK2 {
    F_CHK2() {
        ...
        TEST::SET_W(8, 1 << 15 | 3 << 12| 1 << 11);
        TEST::SET_W(10, TEST_BREAK);

        // CHK2.W (%A2), %D3
        TEST::SET_W(12, 0001320 | 2);
        TEST::SET_W(14, 3 << 12| 1 << 11);
        TEST::SET_W(16, TEST_BREAK);

        // CHK2.W (%A2), %A3
        TEST::SET_W(18, 0001320 | 2);
        TEST::SET_W(20, 1 << 15 | 3 << 12| 1 << 11);
        ...
        TEST::SET_W(32, 1 << 15 | 3 << 12| 1 << 11);
        TEST::SET_W(34, TEST_BREAK);

        jit_compile(0, 36);
    }};
BOOST_FIXTURE_TEST_SUITE(CHK2, Prepare, *boost::unit_test::fixture<F_CHK2>())
...
BOOST_AUTO_TEST_CASE(Under) {
    ...
    cpu.A[2] = 0x100;
    cpu.D[3] = 20;
	run_test(0, EXCEPTION_NUMBER::CHK_FAIL);
    BOOST_TEST(cpu.C);
}
...
BOOST_AUTO_TEST_CASE(Under) {
    ...
    cpu.A[2] = 0x100;
    cpu.A[3] = -100;
	run_test(6, EXCEPTION_NUMBER::CHK_FAIL);
    BOOST_TEST(cpu.C);
}
...
BOOST_AUTO_TEST_CASE(Under) {
    ...
    cpu.A[2] = 0x100;
    cpu.D[3] = 2000;
	run_test(12, EXCEPTION_NUMBER::CHK_FAIL);
    BOOST_TEST(cpu.C);
}
...
BOOST_AUTO_TEST_CASE(Under) {
    ...
    cpu.A[2] = 0x100;
    cpu.A[3] = -1000;
	run_test(18, EXCEPTION_NUMBER::CHK_FAIL);
    BOOST_TEST(cpu.C);
}
...
BOOST_AUTO_TEST_CASE(Under) {
    ...
    cpu.A[2] = 0x100;
    cpu.D[3] = 200000;
	run_test(24, EXCEPTION_NUMBER::CHK_FAIL);
    BOOST_TEST(cpu.C);
}
...
BOOST_AUTO_TEST_CASE(Under) {
    ...
    cpu.A[2] = 0x100;
    cpu.A[3] = -100000;
	run_test(30, EXCEPTION_NUMBER::CHK_FAIL);
    BOOST_TEST(cpu.C);
}
