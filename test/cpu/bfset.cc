...
BOOST_AUTO_TEST_CASE(both_imm) {
    ...
    run_test(24);
    BOOST_TEST(TEST::GET_L(0x100) == 0x12F45678);
}
...
BOOST_AUTO_TEST_CASE(byte2) {
    ...
    cpu.D[5] = 8;
    run_test(42);
    BOOST_TEST(TEST::GET_W(0x100) == 0x1FF4);
}
...
BOOST_AUTO_TEST_CASE(byte3) {
    ...
    cpu.D[5] = 16;
    run_test(42);
    BOOST_TEST(TEST::GET_L(0x100) == 0x1FFFF678);
}
...
BOOST_AUTO_TEST_CASE(byte4) {
    ...
    cpu.D[5] = 24;
    run_test(42);
    BOOST_TEST(TEST::GET_L(0x100) == 0x1FFFFFF8);
}
...
BOOST_AUTO_TEST_CASE(byte5) {
    ...
    cpu.D[5] = 0;
    run_test(42);
    BOOST_TEST(TEST::GET_L(0x100) == 0x1FFFFFFF);
    BOOST_TEST(RAM[0x104] == 0xFA);
}
