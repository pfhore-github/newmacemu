-- BCHG.B #3, (%A4)
MEM[0].W = OCT "004120" | 4
MEM[2].W = 3
MEM[4].W = TEST.BREAK

-- BCHG.B %D2, (%A4)
MEM[6].W = OCT "002520" | 4
MEM[8].W = TEST.BREAK

-- BCHG.L #20, %D4
MEM[10].W = OCT "004100" | 4
MEM[12].W = 20
MEM[14].W = TEST.BREAK

-- BCHG.L %D2, %D4
MEM[16].W = OCT "002500" | 4
MEM[18].W = TEST.BREAK
...
run.B = {
    ...
    byImm = farray(TF, function(z)
        ...
        TEST.CHECK("MEM[0x1000].B", cond(z, 1 << 3, 0))
    end),
    byReg = function()
        MEM[0x1000].B = 1 << 3
        CPU.D[3].L = 3
...
run.L = {
    byImm = farray(TF, function(z)
        ...
        TEST.RUN(10)
        TEST.CHECK("CPU.CC.Z", z)
        TEST.CHECK("CPU.D[5].L", cond(z, 1 << 20, 0))
    end),
    byReg = function()
        CPU.D[5].L = 1 << 20
        CPU.D[3].L = 20
