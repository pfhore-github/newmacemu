...
std::pair<std::function<void()>, int> decode_op8(int dn, int sz, int type,
    ...
    case 4:
        if(type == 0) {
            ...
            return {[dn, reg]() {
                        ...
                        MMU_WriteB(cpu.A[reg], BIN2BCD(d));
                    },
                    0};
        } else {
            // OR.B to MEM
    ...
    case 5:
        if(type == 0) {
            ...
            return {[dn, reg, adj]() {
                        int d = cpu.D[reg] + adj;
                        STORE_B(cpu.D[dn], (d & 0xf) | (d & 0xf00) >> 4);
                    },
                    2};
        } else if(type == 1) {
            // PACK.M
            ...
            return {[dn, reg, adj]() {
                        ...
                        d += adj;
                        MMU_WriteB(--cpu.A[dn], (d & 0xf) | (d & 0xf00) >> 4);
                    },
                    2};
        } else {
            // OR.W to MEM
...
std::pair<std::function<void()>, int> decode_op9(int dn, int sz, int type,
    ...
    case 5:
        if(type == 0) {
            ...
            return {[dn, reg]() {
                        bool zz = cpu.Z;
                        uint16_t v = SUB_W(cpu.D[reg], cpu.D[dn] + cpu.X);
                        STORE_W(cpu.D[reg], v);
                        cpu.Z = v ? false : zz;
                    },
                    0};
            ...
            return {[dn, reg]() {
                        ...
                        bool zz = cpu.Z;
                        uint16_t v = SUB_W(MMU_ReadW(dst_adr),
    ...
    case 6:
        if(type == 0) {
            ...
            return {[dn, reg]() {
                        bool zz = cpu.Z;
                        uint32_t v = SUB_L(cpu.D[reg], cpu.D[dn] + cpu.X);
                        cpu.D[reg] = v;
                        cpu.Z = v ? false : zz;
                    },
                    0};
            ...
            return {[dn, reg]() {
                        ...
                        bool zz = cpu.Z;
                        uint32_t v = SUB_L(MMU_ReadL(dst_adr),
    ...
    if(type == 0) {
        if(offset_r) {
            ...
            if(width_r) {
                ...
                case 7:
                    return {[offset, width, reg, reg2]() {
                                cpu.D[reg] = BFINS_D(cpu.D[reg], offset,
                                                     cpu.D[width], cpu.D[reg2]);
                            },
                            2};
                }
